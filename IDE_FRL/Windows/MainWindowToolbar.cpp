...
{
    toolbar_1_start_interpretator_btn->setToolTip(t_main->t_menu->interpretator_start_action->text());
    toolbar_1_stop_interpretator_btn->setToolTip(t_main->t_menu->interpretator_stop_action->text());
    toolbar_1_clear_interpretator_btn->setToolTip(t_main->t_menu->interpretator_clear_action->text());
