...
LexerLisp::LexerLisp(QObject *parent) :
    QsciLexer(parent)
{
}

const char * LexerLisp::keywords(int set) const
{
...
QString LexerLisp::description(int style) const
{
  switch (style)
  {
...
QColor LexerLisp::defaultColor(int style) const
{
  switch (style)
  {
  case SCE_LISP_DEFAULT:
